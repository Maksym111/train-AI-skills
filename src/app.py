...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team play, fitness, and match strategy",
        "schedule": "Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": []
    },
    "Basketball Club": {
        "description": "Develop shooting, dribbling, and game awareness",
    ...
    "Science Olympiad": {
        "description": "Solve challenging problems in biology, chemistry, and physics",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 10,
        "participants": []
    }
